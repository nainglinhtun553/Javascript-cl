...
function News(title,author,year,month){
	Magazine.call(this,title,author,year); //inhertence
	this.month=month;

}


News.prototype=Object.create(Magazine.prototype); // magazine inhertence.
var page=new News("Myanmer","U Aung","2010","June");
// console.log(page);
